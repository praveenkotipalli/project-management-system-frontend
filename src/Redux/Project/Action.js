...
export const fetchProjects=({category, tag})=>async(dispatch)=>{
    ...
    try {
        ...
        console.log("all projects success", data);
...
export const searchProjects=(keyword)=>async(dispatch)=>{
    ...
    try {
        ...
        console.log("all searched projects success", data);
...
export const createProject=(projectData)=>async(dispatch)=>{
    ...
    try {
        ...
        console.log("created project success", data);
...
export const fetchProjectById=(id)=>async(dispatch)=>{
    ...
    try {
        ...
        console.log("fetched project by id success", data);
...
export const deleteProject=({projectId})=>async(dispatch)=>{
    ...
    try {
        ...
        console.log("deleted project success", data);
...
export const acceptInvitation=({invitationToken, navigate})=>async(dispatch)=>{
    ...
    try {
        ...
        console.log("invitation accepted success", data);
